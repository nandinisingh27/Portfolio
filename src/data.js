...
desc: "High-performance Student Portal serving 8,000+ daily users at KIET Group Of Institutions. Features attendance tracking, class schedules, fee payment system, and PWA capabilities with offline support.",
tech: ["Django", "MySQL", "Celery",],
...
desc: "Bulk certificate generation with CSV import, templates and ZIP packaging.",
...
desc:"Developed a scalable backend for a Hostel Grievance Management System, streamlining complaint handling with structured escalation, real-time tracking, and automated staff assignment—improving accountability and speeding up resolution.",
tech: ["Django","Celery","Redis","MySQL"],
img: "https://source.unsplash.com/800x600/?certificate,design",
github: "https://github.com/nandinisingh27/CampusCare"},
{
title: "Space Weather Notifier",
desc: "Built a system that collects and analyzes data on space disasters, notifying users with timely updates and insights. Designed a user-friendly dashboard with storytelling elements to simplify complex events, and integrated text-to-speech (TTS) for an accessible, immersive experience.",
...
desc: "Puppeteer-based automation extractor for WhatsApp chats and data processing.",
